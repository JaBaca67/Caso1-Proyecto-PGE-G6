...
def readInfo():
    ...
    sales = validaciones.validateSales(
        "Ingrese el monto total de ventas: ", sellerName
    )  # Pasamos el nombre del vendedor como argumento para mostrarlo en la validación de ventas

    # Guardamos los datos validados en el diccionario y los retornamos
    SellerData = {"sellerName": sellerName, "sales": sales}
